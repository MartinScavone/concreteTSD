...
%
%V2.0 - 2022-03-14 Pi Day -> Added xDomain<0 capability: Use abs(x) when
%evaluating w(x)
%
%V0.1 2021-05-21:
% - Code validated against everFE - 2021-06-01 -> HOORRAY!
%   code revised from original version to error-check
